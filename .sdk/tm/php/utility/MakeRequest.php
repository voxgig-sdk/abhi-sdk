...
// Abhi SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class AbhiMakeRequest
{
    public static function call(AbhiContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new AbhiResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new AbhiResponse($fetched);
        } else {
