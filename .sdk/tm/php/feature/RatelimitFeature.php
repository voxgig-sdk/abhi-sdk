...
class AbhiRatelimitFeature extends AbhiBaseFeature
{
    ...
    private function _acquire(AbhiContext $ctx): void
    {
    ...
    private function _track(AbhiContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
