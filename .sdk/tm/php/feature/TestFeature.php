...
// Abhi SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class AbhiTestFeature extends AbhiBaseFeature
{
    ...
    public function init(AbhiContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (AbhiContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (AbhiContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(AbhiContext $ctx, $op, $args): array
    {
