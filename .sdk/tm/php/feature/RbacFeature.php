...
class AbhiRbacFeature extends AbhiBaseFeature
{
    ...
    private function _required(AbhiContext $ctx): ?string
    {
    ...
    private function _reject(AbhiContext $ctx, string $required): void
    {
    ...
    private function _track(AbhiContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
