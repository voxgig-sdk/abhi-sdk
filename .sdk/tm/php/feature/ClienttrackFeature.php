...
class AbhiClienttrackFeature extends AbhiBaseFeature
{
    ...
    public function PostConstruct(AbhiContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Abhi-SDK';
