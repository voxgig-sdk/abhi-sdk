...
from projectname_sdk import AbhiSDK
from core.spec import AbhiSpec
from core.result import AbhiResult
from core.response import AbhiResponse
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = AbhiSDK.test(None, None)
        ...
        class TestInitFeature(AbhiBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(AbhiBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = AbhiSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = AbhiSDK.test(None, setup_opts)
