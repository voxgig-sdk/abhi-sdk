...
module AbhiTestRunner
  ...
  def self.env_override(m)
    live = getenv("ABHI_TEST_LIVE")
    override = getenv("ABHI_TEST_OVERRIDE")
    ...
    explain = getenv("ABHI_TEST_EXPLAIN")
    m["ABHI_TEST_EXPLAIN"] = explain if explain && !explain.empty?
