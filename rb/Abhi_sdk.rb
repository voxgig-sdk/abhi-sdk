...
class AbhiSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = AbhiHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = AbhiHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, AbhiFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def prepare(fetchargs = {})
    ...
    params = AbhiHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = AbhiHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def direct(fetchargs = {})
    ...
    if fetched.is_a?(Hash)
      status = AbhiHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
