...
class ToolEntity
  ...
  # Load a single Tool.
  #
  # @param reqmatch [ToolLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Tool.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Tool, Hash] the loaded Tool; raises AbhiError on failure
  ...
  # Create a new Tool.
  #
  # @param reqdata [ToolCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Tool, Hash] the created Tool; raises AbhiError on failure
