...
class LogoEntity
  ...
  # @return [Logo, Hash] the current Logo data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Logo fields)
  def match_get
  ...
  # Load a single Logo.
  #
  # @param reqmatch [LogoLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Logo.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Logo, Hash] the loaded Logo; raises AbhiError on failure
