...
class GameEntity
  ...
  #
  # @param reqmatch [GameListMatch, Hash, nil] match filter (any subset of
  #   Game fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Game>, Array] the matching Game items; raises AbhiError on failure
