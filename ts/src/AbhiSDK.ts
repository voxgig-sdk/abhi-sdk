...
class AbhiSDK {
  ...
  static test(testoptsarg?: any, sdkoptsarg?: any) {
    ...
    const testsdk = new AbhiSDK(sdkopts)
    testsdk._mode = 'test'
  ...
  tester(testopts?: any, sdkopts?: any) {
    return AbhiSDK.test(testopts, sdkopts)
  }
  ...
  toString() {
    return 'Abhi ' + this._utility.struct.jsonify(this.toJSON())
  }
