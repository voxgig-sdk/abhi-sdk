...
describe('AnimeEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    if (setup.syntheticOnly) {
      t.skip('live entity test uses synthetic IDs from fixture — set ABHI_TEST_ANIME_ENTID JSON to run live')
      return
    }
...
function basicSetup(extra?: any) {
  ...
  const idmapEnvVal = process.env['ABHI_TEST_ANIME_ENTID']
  ...
  idmap = env['ABHI_TEST_ANIME_ENTID']
