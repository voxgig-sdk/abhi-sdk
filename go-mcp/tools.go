...
type Args struct {
	Entity string         `json:"entity" jsonschema:"anime | download | fun | game | logo | tool"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.AbhiSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "abhi_list",
		Description: "List records from Abhi. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "abhi_load",
		Description: "Load a single record from Abhi. " +
...
func runOp(client *sdk.AbhiSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.AbhiSDK, name string) (sdk.AbhiEntity, error) {
	switch strings.ToLower(name) {
	case "anime":
		return client.Anime(nil), nil
	case "download":
		return client.Download(nil), nil
	case "fun":
		return client.Fun(nil), nil
	case "game":
		return client.Game(nil), nil
	case "logo":
		return client.Logo(nil), nil
	case "tool":
