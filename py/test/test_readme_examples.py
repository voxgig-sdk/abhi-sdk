# Abhi SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AbhiSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AbhiSDK(...) and AbhiSDK.test(...) become
#      AbhiSDK.test({"entity": {...}}) seeding one mock record (id "test01")
