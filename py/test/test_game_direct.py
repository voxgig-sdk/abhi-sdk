...
class TestGameDirect:
    ...
    def test_should_direct_list_game(self):
        setup = _game_direct_setup([
            {"id": "direct01"},
            {"id": "direct02"},
        ])
        _skip, _reason = runner.is_control_skipped("direct", "direct-list-game", "live" if setup["live"] else "unit")
        if _skip:
