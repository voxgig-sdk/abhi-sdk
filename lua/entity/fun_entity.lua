...
local FunEntity = {}
FunEntity.__index = FunEntity


function FunEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, FunEntity)
  self._name = "fun"
  self._client = client
...
function FunEntity:get_name()
  return self._name
end


function FunEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return FunEntity.new(self._client, opts)
end


function FunEntity:data_set(args)
  if args ~= nil then
...
function FunEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function FunEntity:match_set(args)
  if args ~= nil then
...
function FunEntity:stream(action, args, callopts)
...
function FunEntity:_run_op(ctx, post_done)
  local utility = self._utility
