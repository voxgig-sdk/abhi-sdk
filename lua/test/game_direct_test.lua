...
describe("GameDirect", function()
  it("should direct-list-game", function()
    local setup = game_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-game", setup.live and "live" or "unit")
