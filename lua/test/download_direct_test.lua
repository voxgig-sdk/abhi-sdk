...
describe("DownloadDirect", function()
  it("should direct-load-download", function()
    local setup = download_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-download", setup.live and "live" or "unit")
...
function download_direct_setup(mockres)
