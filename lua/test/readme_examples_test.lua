...
-- data to return.
local TEST_SEED = '{ entity = { ["anime"] = { ["test01"] = { id = "test01" } }, ["download"] = { ["test01"] = { id = "test01" } }, ["fun"] = { ["test01"] = { id = "test01" } }, ["game"] = { ["test01"] = { id = "test01" } }, ["logo"] = { ["test01"] = { id = "test01" } }, ["tool"] = { ["test01"] = { id = "test01" } } } }'
