...
describe("FunDirect", function()
  it("should direct-load-fun", function()
    local setup = fun_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-fun", setup.live and "live" or "unit")
...
function fun_direct_setup(mockres)
