...
describe("ToolDirect", function()
  it("should direct-load-tool", function()
    local setup = tool_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-tool", setup.live and "live" or "unit")
...
function tool_direct_setup(mockres)
