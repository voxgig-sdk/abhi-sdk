...
describe("LogoDirect", function()
  it("should direct-load-logo", function()
    local setup = logo_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-logo", setup.live and "live" or "unit")
...
function logo_direct_setup(mockres)
