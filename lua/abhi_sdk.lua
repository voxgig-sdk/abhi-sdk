...
AbhiSDK._make_feature = _make_feature


function AbhiSDK.new(options)
  local self = setmetatable({}, AbhiSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function AbhiSDK:get_utility()
  return Utility.copy(self._utility)
end


function AbhiSDK:get_root_ctx()
  return self._rootctx
end


function AbhiSDK:prepare(fetchargs)
...
function AbhiSDK:direct(fetchargs)
  local utility = self._utility
...
function AbhiSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
