...
The Golang SDK for the Abhi API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/abhi-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/abhi-sdk=../path/to/github.com/voxgig-sdk/abhi-sdk
```
...
```
github.com/voxgig-sdk/abhi-sdk/
...
The root package (`github.com/voxgig-sdk/abhi-sdk`) re-exports everything needed
