...
func (sdk *AbhiSDK) OptionsMap() map[string]any {
...
func (sdk *AbhiSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *AbhiSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *AbhiSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AbhiSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
