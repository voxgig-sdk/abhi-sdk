...
const testSeed = `map[string]any{"entity": map[string]any{"anime": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "download": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "fun": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "game": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "logo": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tool": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
