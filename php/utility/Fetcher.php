...
class AbhiFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AbhiSDK/1.0)';
    ...
    public static function call(AbhiContext $ctx, string $fullurl, array $fetchdef): array
    {
