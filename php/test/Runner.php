...
class AbhiTestRunner
{
    ...
    {
        $live = self::getenv('ABHI_TEST_LIVE');
        $override = self::getenv('ABHI_TEST_OVERRIDE');
        ...
        $explain = self::getenv('ABHI_TEST_EXPLAIN');
...
class_alias('AbhiTestRunner', 'Runner');
class_alias('AbhiHelpers', 'Helpers');
