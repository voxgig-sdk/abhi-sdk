...
class DownloadDirectTest extends TestCase
{
    public function test_direct_load_download(): void
    {
        $setup = download_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-download", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
