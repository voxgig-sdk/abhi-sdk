...
// Abhi SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AbhiSDK::test)
...
{
    private const SDK_CLASS = 'AbhiSDK';
    ...
    private const SDK_BASE = 'abhi_sdk';
