...
class AbhiSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = AbhiHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = AbhiHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ($utility->feature_add)($this->_rootctx, AbhiFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return AbhiUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = AbhiHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = AbhiHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = AbhiHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    public function direct(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = AbhiHelpers::to_int(Struct::getprop($fetched, "status"));
