...
class GameEntity
{
    ...
    /**
     * List Game items matching the given filter.
     *
     * @param GameListMatch|array|null $reqmatch Match filter (any subset
     *   of Game fields) as an assoc-array; GameListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Game[]|array A list of Game items as assoc-arrays at
     *   the SDK boundary; throws AbhiError on failure (item-5 convention).
     */
