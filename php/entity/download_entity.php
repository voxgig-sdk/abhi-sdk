...
class DownloadEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DownloadEntity($this->_client, $opts);
    }

    /**
     * @param Download|array $args Download data (assoc-array) to store.
     */
    ...
    /**
     * @return Download|array The current Download data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Download fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Download fields).
     */
    ...
    /**
     * Load a single Download.
     *
     * @param DownloadLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DownloadLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Download|array The loaded Download as an assoc-array at the
