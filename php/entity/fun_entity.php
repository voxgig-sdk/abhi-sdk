...
class FunEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FunEntity($this->_client, $opts);
    }

    /**
     * @param Fun|array $args Fun data (assoc-array) to store.
     */
    ...
    /**
     * @return Fun|array The current Fun data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Fun fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Fun fields).
     */
     ...
     * Load a single Fun.
     *
     * @param FunLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed FunLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Fun|array The loaded Fun as an assoc-array at the
