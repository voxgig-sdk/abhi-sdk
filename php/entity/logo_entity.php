...
class LogoEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LogoEntity($this->_client, $opts);
    }

    /**
     * @param Logo|array $args Logo data (assoc-array) to store.
     */
    ...
    /**
     * @return Logo|array The current Logo data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Logo fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Logo fields).
     */
     ...
     * Load a single Logo.
     *
     * @param LogoLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed LogoLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Logo|array The loaded Logo as an assoc-array at the
