...
class AbhiTimeoutFeature extends AbhiBaseFeature
{
    ...
    private function _with_timeout(AbhiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AbhiContext $_ctx, float $ms): void
    {
        $client = $this->client;
