...
class AbhiStreamingFeature extends AbhiBaseFeature
{
    ...
    private function _iterate(AbhiResult $result): \Generator
    {
    ...
    private function _streamable(AbhiContext $ctx): bool
    {
