...
class AbhiCacheFeature extends AbhiBaseFeature
{
    ...
    private function _through(AbhiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
