...
class AbhiNetsimFeature extends AbhiBaseFeature
{
    ...
    private function _simulate(AbhiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AbhiContext $ctx, array $applied): void
    {
        $client = $this->client;
