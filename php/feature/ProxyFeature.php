...
class AbhiProxyFeature extends AbhiBaseFeature
{
    ...
    public function init(AbhiContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AbhiContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
